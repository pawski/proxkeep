		...
		cli.Command{
			...
			Action: func(c *cli.Context) error {
				...
				return command.NewRunCommand(
					proxy.NewTester(http.NewHttpClient(appConfig.HttpTimeout)),
			...
			Action: func(c *cli.Context) error {
				return command.
					NewTestCommand(http.NewHttpClient(appConfig.HttpTimeout), getLogger()).
			...
			Action: func(c *cli.Context) error {
				response, err := http.NewHttpClient(appConfig.HttpTimeout).DirectFetch(appConfig.SelfTestUrl)
